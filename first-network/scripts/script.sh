...
if [ "$CC_SRC_LANGUAGE" = "go" -o "$CC_SRC_LANGUAGE" = "golang" ]; then
	...
	CC_SRC_PATH="/opt/gopath/src/github.com/ilovelili/fabric-playground/chaincode/abstore/"
else
...
if [ "${NO_CHAINCODE}" != "true" ]; then
  ...
  ## expecting org1 to have approved and org2 not to
  ...
  ## check whether the chaincode definition is ready to be committed
	## expecting them both to have approved
  ...
  # invoke init (first argument 1 means init flag, then peer0, org1, peer0, org2)
